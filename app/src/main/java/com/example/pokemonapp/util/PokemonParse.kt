...
fun parseStatToColor(stat: com.example.pokemonapp.domain.dtos.pokemon.Stat): Color {
...
fun parseStatToAbbr(stat: com.example.pokemonapp.domain.dtos.pokemon.Stat): String {
